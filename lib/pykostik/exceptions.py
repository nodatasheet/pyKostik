...
class ObjectNotFoundError(PyKostikException):
    """Rise when method returns `None`"""
    pass


class PkElementNotFoundError(ObjectNotFoundError):
    pass


class BoundingBoxNotFoundError(ObjectNotFoundError):
    pass


class ParameterNotFoundError(ObjectNotFoundError):
    pass
